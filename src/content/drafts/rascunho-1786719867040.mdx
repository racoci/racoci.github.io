...
| Western trait language | Parallel/process in Hindu psychology |
| :--- | :--- |
| **Neuroticism** – proneness to anxiety, anger, mood swings | Samskaras of fear/aversion lodged in **chitta**; excess **tamas/rajas** colouring manas |
| **Extraversion** – sociability, positive affect | High **prana** flow toward heart/throat chakras; sattvic manas that seeks contact |
| **Openness to experience** – curiosity, fantasy | Dominant **buddhi** (discriminative intellect) + light sattva; frequent activation of **ajña** chakra |
| **Agreeableness** – altruism, empathy | Harmonious **ahankara** (ego) that identifies with others; cultivated through **bhakti/karma-yoga** |
| **Conscientiousness** – self-discipline, dutifulness | Strong **buddhi** governance over manas; prevalence of sattva |
|  |  |
